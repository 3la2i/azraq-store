...
const ExploreMenu = () => {
  return (
    <div className="flex flex-col gap-5  m-auto" id="explore-menu">
      <h1 className="text-[#262626] font-medium  text-4xl ml-[11.5rem]">
        Explore our menu
      </h1>
      <p className=" text-gray-600  ml-[11.5rem] ">
        Choose from a diverse menu featuring a delectable array of dishes
        crafted with the finest ingredients and culinary expertise. Our menu
        satisfies your cravings, enhancing your dining experience, one delicious
        meal at a time.
      </p>
      <div className="flex justify-between rounded-3xl  ml-10 mr-10  items-center gap-7 text-center my-5 overflow-x-scroll h-full scrollbar-hide h-16">
